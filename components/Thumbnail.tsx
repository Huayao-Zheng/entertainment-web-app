  ...
  return (
    <div className="relative">
      <div
        ...
        className="revealPlayOnHover relative min-h-[140px] min-w-[240px] cursor-pointer transition duration-200 ease-out md:min-h-[230px] md:min-w-[470px] md:hover:scale-105"
      >
        <Image
      ...
      <div onClick={() => setBook(!book)} className="bookmark cursor-pointer">
        {book ? (
